    ...
    return (
        <div style={{
            ...
            <div style={{ overflowX: "hidden" }}>
                ...
                <Header />
                <div className="container" style={{ justifyContent: "flex-start", alignItems: "center", display: "flex", marginLeft: "15%" }}>
                    <div className="row">
                        <div className="col-lg" style={{ background: "rgba(255, 255, 255, 0.6)", padding: "20px", width: "100%"}}>
